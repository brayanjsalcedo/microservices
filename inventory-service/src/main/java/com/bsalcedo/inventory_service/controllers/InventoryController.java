package com.bsalcedo.inventory_service.controllers;
...
import com.bsalcedo.inventory_service.services.InventoryService;
...
public class InventoryController {
    ...
    public BaseResponse areInStock(@RequestBody List<OrderItemRequest> orderItemRequests) {
        return this.inventoryService.areInStock(orderItemRequests);
    }
